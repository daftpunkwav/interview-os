...
from app.services.voice.credentials import build_stt_credentials
from app.services.voice.stage_tests import _normalize_zh, load_fixture
...
def test_stt_fixture_packaged_locally():
    ...
    fixture_dir = Path(__file__).resolve().parents[1] / "app" / "data" / "stt_fixtures"
