...
from app.core.security import make_pinned_async_client, redact_api_key
...
def _decode_audio(pcm_b64: str) -> bytes:
    try:
        ...
        if raw[:4] == b"RIFF":
            return raw
        from app.services.stt.cloud import pcm_base64_to_wav_bytes
...
async def transcribe_pcm_cloud(
    ...
    *,
    ...
    from app.services.stt.cloud import transcribe_pcm_cloud as _cloud
