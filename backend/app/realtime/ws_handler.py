...
from app.realtime.hint_service import HintServiceMixin
from app.realtime.report_scheduler import ReportSchedulerMixin
...
from app.realtime.turn_coordinator import (
    TurnCoordinatorMixin,
    _AUDIO_BUFFER_MAX_BYTES,
    _IMAGE_BASE64_MAX_LEN,
)
from app.realtime.voice_pipeline import (
    VoicePipelineMixin,
    _SentenceTTSQueue,
...
from app.services.stt import SttCredentials, SttResult, transcribe_utterance  # noqa: F401
from app.services.tts import TtsCredentials, synthesize_speech  # noqa: F401 — 测试 patch
from app.services.tts.voice_resolve import VoiceProsody
...
_WS_LLM_RATE_LIMIT = __import__(
    "app.core.constants", fromlist=["DEFAULT_LLM_RATE_LIMIT_PER_MINUTE"]
